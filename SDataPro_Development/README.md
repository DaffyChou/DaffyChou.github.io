...
| 項目 | 真實資料 |
|---|---|
| 自家船 | **20 艘**（src 9, 12, 13, 16, 17, 22, 23, 24, 25, 28, 29, 31, 33, 34, 36, 45, 49, 50, 53, 54） |
| 時間範圍 | 2026-05-25 ~ 2026-06-02（8 天） |
| 船隊組成 | **陽明海運貨櫃船 18 艘** + 长宏拖5 港口拖船 1 艘 + NO.1 EUNHEE 韓國油輪 1 艘 |
| 國籍 | 🇹🇼 6 / 🇨🇳 1 / 🇱🇷 10 / 🇰🇷 1 / 🇸🇬 2 |
| 觀測海域 | 亞太為主（台海、東海、南海、馬六甲、巴士海峽、太平洋橫渡）|
| 周邊船密度 | 平均 4.5 ~ 63 艘 / 船 / 5 NM（拖船 src 13 因停泊長江口協助大船靠泊，周邊密度最高）|
...
| Demo 場景 | 推薦使用船 | 理由 |
|---|---|---|
| 船隊全景 | 全 20 艘（陽明 18 + 拖船 1 + 油輪 1）| — |
| 旗艦展示 | **src 53 YM TROPHY**（廣東外海，334×48m, 2022 新造旗艦）| 視覺最佳 |
| CPA 高密度查證 | **src 53 YM TROPHY** 或 **src 22 YM EFFICIENCY**（東海）| 大船多周邊密 |
| 港口接近 | **src 49 YM ETERNITY**（巴士海峽→高雄）| 距台灣港近 |
| 跨洋孤立 | **src 9 YM UNANIMITY**（太平洋橫渡）| 周邊最稀疏 4.5 艘 |
| 馬六甲擁擠 | **src 28 YM INSTRUCTION / src 34 YM HAWK / src 45 YM MILESTONE** | 真實船流密集 |
| 港口拖船示範 | **src 13 长宏拖5** | 港口拖船代表，平均 63 艘周邊船最多 |
